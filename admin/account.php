...
<div class="container-fluid">
  ...
  <li class="nav-item dropdown">
    <a class="nav-link active"  href="Account.php" role="button" >Account</a>
  ...
  <li class="nav-item dropdown">
    ...
    <div class="col-10">
      ...
      <div class="container-fluid">
        <center>
        <h2 style="font-family:serif">Account</h2>
      </center>
        <div class="row">
          <div class="col">
...
<button class="btn btn-outline-success me-2" type="button"> Admins List</button>
</nav>
  ...
  <tbody>
    ...
    <tr>
      ...
      <input type="hidden" name="admid" value="<?php echo $row['id'] ?>">
...
<button class="btn btn-outline-success me-2" type="button"> Users List</button>
<div class="container-fluid" >
<table class="table  table">
<thead>
<tr>
...
<td><?php echo $row['email'] ?></td>
  <td>
    <input type="submit"  class="btn btn-sm btn-danger " name="remove1" value="Remove "></td>
    </form>
</tr>
<?php
}
...
if (isset($_POST['remove'])) {
  $admid = $_POST['admid'];
  $query = "DELETE FROM admin WHERE id = '$admid'";
  $query_solution = mysqli_query($con, $query);
  if ($query_solution) {
