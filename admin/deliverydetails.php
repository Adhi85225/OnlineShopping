...
<div class="container-fluid">
  ...
  <li class="nav-item dropdown">
    <a class="nav-link active"  href="deliverydetails.php" role="button" >Delivery Details</a>
...
<!-- <div class="container">
  <img scr="Images\backgroundimages\bg3.jpg">
</div> -->
<div class="col-10">
  <!-- Your Code Here -->
  <div class="container-fluid">
    <center>
    <h2 style="font-family:serif">Delivery Details</h2>
  </center>
    <div class="row">
      <div class="col-auto" style="float:right">
        <button class="btn btn-outline-success me-2" type="button"> Delivery-persons</button>
      </div>
    </div>
    <div class="container-fluid" >
...
<tbody>
  ...
  <td><?php echo $row['email'] ?></td>
    <td>
      <input type="submit"  class="btn btn-sm btn-danger " name="remove" value="Remove "></td>
      </form>
  </tr>
  <?php
}
...
<button class="btn btn-outline-success me-2" type="button"> Delivery-Details</button>
<div class="container">
  <table class="table table-responsive">
    ...
    <tbody>
      <?php
      $id = $_SESSION['delid'];
      $query = "SELECT a.id, b.name, a.product_name, a.quantity, a.totalprice, a.address, a.status FROM buy as a, users as b WHERE a.userid = b.email and a.DeliveryBoyId = '$id'";
      $query_solution = mysqli_query($con, $query);
      if ($query_solution) {
        while ($row = mysqli_fetch_array($query_solution)) {
          ?>
          <tr>
            <form class="" action="../admin/deliverydetails.php" method="post">
            ...
            <?php  }
             ...
             ?>
            <td><input type="submit" class="btn btn-sm btn-success" name="deliver" value="Delivered"/></td>
            <?php
          }
             ?>
            </form>
...
if (isset($_POST['deliver'])) {
  $id = $_POST['id'];
  $querys = "UPDATE buy SET status = 'Delivered' WHERE id = '$id'";
  $query_solutions = mysqli_query($con, $querys);
  if ($query_solutions) {
    echo "<script>alert('done')</script>";
    echo "<script>window.location = '../admin/deliverydetails.php'</script>";
  }
  else {
